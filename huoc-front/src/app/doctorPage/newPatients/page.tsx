...
export default function NewPatientsPage() {
    ...
    const handleViewPatient = (patient: Patient) => {
        ...
        if (clinicalDataRaw) {
            try {
                const allClinicalData: Record<string, ClinicalData> = JSON.parse(clinicalDataRaw);
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <header className="bg-[#DBEAFE] flex items-center justify-between px-6 py-4 shadow-md">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-lg font-semibold text-gray-800">HUOC - Pacientes Novos</h1>
                </div>
                <button
                    onClick={() => router.back()}
