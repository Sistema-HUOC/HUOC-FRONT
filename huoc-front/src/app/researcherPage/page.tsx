...
export default function NurseHome() {
  ...
  const handleNavigateToForm = () => {
    router.push("/researcherPage/centralResearcher");
  };
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-[#BFDBFE] flex items-center justify-between px-6 py-4 shadow-md">
        ...
        <button
          ...
          className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded shadow transition-all transform hover:scale-105 cursor-pointer"
          title="Sair"
        >
          Sair
        </button>
      ...
      >
        <div className="bg-white bg-opacity-60 rounded-2xl shadow-xl p-10 max-w-3xl w-full text-center">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">
            Bem-vindo à Área do Pesquisador
          </h1>
          ...
          <button
            onClick={() => router.push("/researcherPage/centralResearcher")}
            className="bg-blue-600 hover:bg-blue-700 text-white text-lg font-semibold py-4 px-8 rounded-full shadow-lg transition-all transform hover:scale-105 cursor-pointer"
          >
